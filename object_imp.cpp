...
void astronomical_object::update_type(std::string input) { type = input; }
...
inline astronomical_object &
astronomical_object::operator=(astronomical_object &object) {
  if (&object == this)
    return *this;
  id = object.id;
  redshift = object.redshift;
...
inline astronomical_object::astronomical_object(
    astronomical_object &&object) noexcept {
...
inline astronomical_object &
astronomical_object::operator=(astronomical_object &&object) noexcept {
