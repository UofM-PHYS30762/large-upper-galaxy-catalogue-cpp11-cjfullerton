...
int main() {
    ...
    int submenu{ 0 };
    while (!programexit) {
        std::cout << "Welcome to ACEO -- The Astronomical Catalogue for Extragalactic Objects--" << std::endl;
        std::cout << "This is the Main menu -- Please Select a Following option" << std::endl;
        std::string s;
        ...
        case 1: {
                ...
                case 1: {
                    ...
                    std::string s;
                    std::cout << "Please enter the ID you wish to name the catalogue, please make it a 4 digit number" << std::endl;
                    do {
                        try {
                            std::cin >> s;
        ...
        case 2: {
            ...
            std::cout << "Please select the catalogue you wish to inspect:" << std::endl;
            std::string catalogue_choice{};
            std::cin >> catalogue_choice;
            auto it = std::find_if(cat_vector.begin(), cat_vector.end(),
            ...
            if (it != cat_vector.end()) {
                ...
                std::cout << "Please select what you want to do with this catalogue." << std::endl;
                ...
                case 2: {
                    ...
                    std::cout << "Please enter the ID of the object you wish to delete" << std::endl;                   
                    std::string id_del;
                    do {
                        try {
                            std::cin >> id_del;
                ...
                case 4: {
                    std::cout << "Please enter the filename you wish to use (xxxxx.csv)" << std::endl;
                    std::string filename{};
            ...
            else { std::cout << "That catalogue does not exist" << std::endl; }
        ...
        case 3: {
            ...
            std::cout << "Please select the catalogue you wish to delete:" << std::endl;
            
            std::cin >> delete_choice;

            try {
                auto it_1 = std::find_if(cat_vector.begin(), cat_vector.end(),
